...
const privacy = {
  ru: {
    ...
    sections: [
      ...
      { title: "5. Сервис рассылки Brevo", paragraphs: ["Для хранения списка подписчиков и отправки писем используется сервис Brevo.", "Brevo обрабатывает данные подписчиков от имени владельца рассылки как поставщик технических услуг.", "Поскольку Brevo и некоторые его поставщики услуг могут находиться за пределами страны проживания пользователя, персональные данные могут обрабатываться за рубежом."] },
  ...
  uk: {
    ...
    sections: [
      ...
      { title: "5. Сервіс розсилки Brevo", paragraphs: ["Для зберігання списку підписників та надсилання листів використовується сервіс Brevo.", "Brevo обробляє дані підписників від імені власника розсилки як постачальник технічних послуг.", "Оскільки Brevo та деякі його постачальники послуг можуть бути розташовані за межами країни проживання користувача, персональні дані можуть оброблятися за кордоном."] },
