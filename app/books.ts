...
export const booksCopy: Record<Lang, BooksCopy> = {
  ru: {
    ...
    series: "Серия",
    ctaText:
      "Подпишитесь на новости Симоны Вилар, чтобы узнать о новых публикациях и о том, когда и где книги будут доступны для покупки.",
  ...
  uk: {
    ...
    series: "Серія",
    ctaText:
      "Підпишіться на новини Сімони Вілар, щоб дізнаватися про нові публікації та про те, коли і де книжки будуть доступні для придбання.",
